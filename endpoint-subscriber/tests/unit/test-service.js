...
describe('Tests SubscriptionService Repository', function () {
    ...
    it('verifies SubscriptionService emailSubscription method success with only required params', async () => {
    ...
    it('verifies SubscriptionService emailSubscription method verifies missing attributes param', async () => {
        var updateEndpointFake = sinon.fake.returns({
            MessageBody: {
                Message: "OK",
                RequestID: "Req-001"
